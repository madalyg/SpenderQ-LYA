...
def clean_lyalpha_residuals(wave_rest, flux_obs, flux_spender_continuum):
    ...
    """
    # Normalize the spectrum. Flattens the continuum to ~1.0 and isolates all absorption features
    ...
    smooth_features = median_filter(flux_norm, size=60)
    ...
    forest_threshold = 0.05  # To adjust based on data noise
